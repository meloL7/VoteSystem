...
function registStudent() {
    ...
    $.ajax({
        ...
        type:"post",
        data:{'sno':sno,'identify':'学生','email':email,'pwd':pwd,'sname':sname,'sex':sex,'age':age,'colleage':colleage,'major':major,'grade':grade,'classes':classes},
        dataType:"json",
        success:function (data) {
            if (reg.exec(pwd)) {
                if (data.result) {
